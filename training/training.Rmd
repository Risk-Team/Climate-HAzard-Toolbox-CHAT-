...
## Setting the scene
 ...
 The Hub is made of 5 main functions:
...
`proj(data, save, plot_name, season, lowert=NULL, uppert=NULL, int_month=NULL, trends, palette=NULL, bias.correction, prov.country=NULL)`
...
`proj(data, save, plot_name, season, lowert=NULL, uppert=NULL, int_month=NULL, trends, palette=NULL, prov.country=NULL)`
...
`trends(data, save, plot_name, season, lowert=NULL, uppert=NULL, int_month=NULL, y.range=NULL, bias.correction)`
...
`trends(data, save=TRUE, bias.correction=TRUE, season=1:3, uppert=20)`

![Fig.12. Yearly increase in total number of heavy rainfall events in Kenya, January-March, after bias correction. The regression line is fitted based on the ensemble mean of 6 CORDEX-CORE models while shading represents the standard deviation. Figure produced with the Climate HAzard toolbox (CHAT) developed at FAO (Climate Risk Team).   ](figures/Kenya_trends_bias_uppert 1-2-3.png)